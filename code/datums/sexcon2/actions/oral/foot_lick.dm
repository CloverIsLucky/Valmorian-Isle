...
/datum/sex_action/oral/foot_lick/on_start(mob/living/carbon/human/user, mob/living/carbon/human/target)
	. = ..()
	if(user == target)
		user.visible_message(span_warning("[user] starts using [user.p_their()] severed head to lick [user.p_their()] own feet..."))
	else
...
/datum/sex_action/oral/foot_lick/on_finish(mob/living/carbon/human/user, mob/living/carbon/human/target)
	. = ..()
	user.visible_message(span_warning("[user] stops licking [tgt_poss(user, target)] feet ..."))
...
/datum/sex_action/oral/foot_lick/on_perform_message(mob/living/carbon/human/user, mob/living/carbon/human/target)
	...
	user.visible_message(sex_session.spanify_force("[user] [sex_session.get_generic_force_adjective()] licks [tgt_poss(user, target)] feet..."))

...
/datum/advclass/foreigner/lesserblackoak
	name = "Black Oaken Grovewalker"
	tutorial = "Autumn's grace trails you as a scout and auxiliary of the Black Oaks; a paramilitary group from \
	Amerland involved in mercenary work to bring home money. More covertly, the Black Oaks are also involved in \
	espionage and persecution of political refugees, dissenters and rebels from Amerland. \
	Whether through blade or bow, you shall ensure your land's prosperity and make those who dare to sully \
	Amerland's dark forests regret it."
	extra_context = "This class is restricted to the Elf, Dark Elf, Sun Elf, Half-Elf and Human species."
	class_select_category = CLASS_CAT_RACIAL
	allowed_sexes = list(MALE, FEMALE)
	forbidden_races = list(RACES_BLACKOAK_LESSER)
	...
	subclass_languages = list(/datum/language/elvish) //Filthy collaborators (humans) don't know Elvish by default. This ensures they do.
